/*
 * Created by JFormDesigner on Mon Apr 30 02:29:43 CDT 2018
 */
...
public class UserUpdateForm extends JFrame {
	 ...
	 * 
	 */
	SQLUpdate update = new SQLUpdate(DbPath.path);
	DataBaseStuffForm dbstuff = new DataBaseStuffForm();
	private static final long serialVersionUID = 1699119754670723481L;
	public UserUpdateForm() {
		initComponents();
		this.setVisible(true);
		this.setLocationRelativeTo(null);
		this.pack();
		this.add(mainPanelUpdate);
	}
	...
	private void btn_confirmMouseClicked(MouseEvent e) {
		// TODO add your code here
		...
		update.updateUser(userName, password, name, age, favGenre, favGame, budget);
		messagePopUp.message("Update info for:" + name , "Confirm Update");
	...
	private void initComponents() {
		...
		//======== mainPanelUpdate ========
		{
			mainPanelUpdate.setBackground(new Color(102, 102, 102));

			// JFormDesigner evaluation mark
			mainPanelUpdate.setBorder(new javax.swing.border.CompoundBorder(
				new javax.swing.border.TitledBorder(new javax.swing.border.EmptyBorder(0, 0, 0, 0),
					"JFormDesigner Evaluation", javax.swing.border.TitledBorder.CENTER,
					javax.swing.border.TitledBorder.BOTTOM, new java.awt.Font("Dialog", java.awt.Font.BOLD, 12),
					java.awt.Color.red), mainPanelUpdate.getBorder())); mainPanelUpdate.addPropertyChangeListener(new java.beans.PropertyChangeListener(){public void propertyChange(java.beans.PropertyChangeEvent e){if("border".equals(e.getPropertyName()))throw new RuntimeException();}});
			...
			//======== panel2 ========
			{
				...
				//---- lbl_userUpdateInfo ----
				lbl_userUpdateInfo.setText("<html>Welcome, User! Please update the following information below.<br>**Hit Confirm to continue, or Cancel to go back to previous screen**");
				lbl_userUpdateInfo.setFont(new Font("Tahoma", Font.BOLD, 14));
				...
				panel2Layout.setHorizontalGroup(
					panel2Layout.createParallelGroup()
						.addGroup(panel2Layout.createSequentialGroup()
							.addGap(36, 36, 36)
							.addComponent(lbl_userUpdateInfo, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
			...
			GroupLayout mainPanelUpdateLayout = new GroupLayout(mainPanelUpdate);
			mainPanelUpdate.setLayout(mainPanelUpdateLayout);
			mainPanelUpdateLayout.setHorizontalGroup(
				mainPanelUpdateLayout.createParallelGroup()
					...
					.addGroup(mainPanelUpdateLayout.createSequentialGroup()
						.addGap(140, 140, 140)
						.addComponent(UserInfoPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addContainerGap(140, Short.MAX_VALUE))
			);
			mainPanelUpdateLayout.setVerticalGroup(
				mainPanelUpdateLayout.createParallelGroup()
					.addGroup(GroupLayout.Alignment.TRAILING, mainPanelUpdateLayout.createSequentialGroup()
		...
		contentPaneLayout.setHorizontalGroup(
			contentPaneLayout.createParallelGroup()
				.addComponent(mainPanelUpdate, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
		);
	...
	// Generated using JFormDesigner Evaluation license - Trevor Taylor
	private JPanel mainPanelUpdate;
	...
	private JLabel lbl_userUpdateInfo;
