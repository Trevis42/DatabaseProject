						...
						searchInputPanel2Layout.setHorizontalGroup(
							searchInputPanel2Layout.createParallelGroup()
								.addGroup(searchInputPanel2Layout.createSequentialGroup()
									.addContainerGap()
									.addComponent(btn_logout2, GroupLayout.PREFERRED_SIZE, 184, GroupLayout.PREFERRED_SIZE)
									.addGap(52, 52, 52)
									.addComponent(lbl_WishlistOf, GroupLayout.PREFERRED_SIZE, 111, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
									.addComponent(lbl_userNameWL, GroupLayout.DEFAULT_SIZE, 195, Short.MAX_VALUE)
									.addContainerGap())
								.addComponent(scrollPane6, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 568, Short.MAX_VALUE)
						);
						searchInputPanel2Layout.setVerticalGroup(
							searchInputPanel2Layout.createParallelGroup()
								.addGroup(GroupLayout.Alignment.TRAILING, searchInputPanel2Layout.createSequentialGroup()
									.addComponent(scrollPane6, GroupLayout.PREFERRED_SIZE, 420, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
									.addGroup(searchInputPanel2Layout.createParallelGroup()
										.addComponent(btn_logout2, GroupLayout.PREFERRED_SIZE, 42, GroupLayout.PREFERRED_SIZE)
										.addGroup(GroupLayout.Alignment.TRAILING, searchInputPanel2Layout.createSequentialGroup()
